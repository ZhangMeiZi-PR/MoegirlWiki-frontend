...
import { Editor, EditorContent, EditorContext, useCurrentEditor, useEditor } from "@tiptap/react"
    ...
    <>
      ...
      <ToolbarGroup>
        <input
          ...
          value={editor.getAttributes('testStyle').color}
          className="w-6 h-6 cursor-pointer bg-transparent border-none p-0 mx-1 align-middle"
        />
